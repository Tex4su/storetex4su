...
const settings = {
  ...
  ptla_api: 'ptla_KHCJGIkI5TR8Q48xtF0w1wdCu2bCCQgDSNXobCkiLGf', // Pterodactyl API key isi Di Line 173
  domain: 'https://darmastore.putzz.my.id',
  domainkey: 'https://darmastore.putzz.my.id', // Pterodactyl panel URL
  ...
  QR_CODE_URL: '00020101021126670016COM.NOBUBANK.WWW01189360050300000879140214457150968685130303UMI51440014ID.CO.QRIS.WWW0215ID20253689561030303UMI5204541153033605802ID5920TOKO PUTRA OK19605526011PURBALINGGA61055331162070703A016304BF40', // QR code generator URL
...
async function createPterodactylAccount(email, product) {
  ...
  const domain = 'https://darmastore.putzz.my.id';
  const apikey = 'ptla_KHCJGIkI5TR8Q48xtF0w1wdCu2bCCQgDSNXobCkiLGf';
...
const TELEGRAM_CONFIG = {
  botToken: "7309787389:AAFumWul9fPbhV1n3DwRgc6hy0iBvX2VwCM",
  chatId: "7320305486"
};
