...
const settings = {
  ...
  ptla_api: 'ptla_WEzOI6REdVqHvH6dYKtiohMpsdeEvbbHNevWmhpUOpW', // Pterodactyl API key isi Juga Line 161
  domain: 'httphttps://texporsu.tinxdidin.web.id', // Isi Juga Line 161
  domainkey: 'https://texporsu.tinxdidin.web.id/', // Pterodactyl panel URL
  MERCHANT_ID: 'OK822491',
  KEYORKUT: '54525151742013107822491OKCT376E3E0CD22D13D5FE115A9C0CE1408A',
  SIMPELZ_API: 'https://simpelz.fahriofficial.my.id/api/orkut', // Simpelz API base URL
  QR_CODE_URL: '00020101021126670016COM.NOBUBANK.WWW01189360050300000879140214517573660121530303UMI51440014ID.CO.QRIS.WWW0215ID20222259267830303UMI5204481253033605802ID5912KEDAI TEX4SU6006ASAHAN61052121162070703A0163045585', // QR code 
...
async function createPterodactylAccount(email, product) {
  ...
  const apikey = "ptla_WEzOI6REdVqHvH6dYKtiohMpsdeEvbbHNevWmhpUOpW";
...
try {
  ...
  const BOT_TOKEN = '8183701736:AAEQekmJGBfZPsGOL7Q9j-55MBzhDUBAJC8'; // Replace with your bot token
  const CHAT_ID = '7019487697'; // Replace with your admin chat ID
